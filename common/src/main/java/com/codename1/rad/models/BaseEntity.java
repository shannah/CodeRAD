...
public class BaseEntity extends Observable implements Entity  {
    ...
    public boolean setEntity(Tag tag, Entity e) {
        return set(tag, e == null ? ContentType.EntityType : e.getEntity().getEntityType().getContentType(), e);
    }
    ...
    public boolean setEntity(Entity e, Tag... tags) {
        return set(e == null ? ContentType.EntityType : e.getEntity().getEntityType().getContentType(), e, tags);
    }
    ...
    private java.util.ArrayList<Entity> wrappers;
    private java.util.ArrayList<Entity> wrappers() {
        if (wrappers == null) {
    ...
    public void addWrapper(Entity wrapper) {
        wrappers().add(wrapper);
    }
    
    public <T extends Entity> T getWrapper(Class<T> type) {
        for (Entity e : wrappers()) {
...
//            return (T)e;
//        }
//        for (Object o : e.getEntity().wrappers()) {
//            if (type.isAssignableFrom(o.getClass())) {
//                return (T)o;
//            }
//        }
//        EntityType et = e.getEntity().getEntityType();
//        T wrapper =  et.createWrapperFor(e.getEntity(), type);
//        if (wrapper != null) {
//            e.getEntity().wrappers.add(wrapper);
//        }
//        return wrapper;
//
//    }
...
//        return BaseEntity.wrap(type, this);
//    }
//
//
//    @Override
//    public <T> T getWrappedEntity(Property prop, Class<T> wrapperType) {
//        return BaseEntity.wrap(wrapperType, getEntity(prop));
//    }
//
//    @Override
//    public <T> T getWrappedEntity(Tag tag, Class<T> wrapperType) {
//        return BaseEntity.wrap(wrapperType, getEntity(tag));
//    }
