...
public class ActionNode extends Node implements Proxyable {
	...
	public static ActionNode.ActionNodeEvent getActionNodeEvent(ActionEvent evt) {
	}

	public static ActionNode.ActionNodeEvent getActionNodeEvent(ActionEvent evt, ActionNode action) {
	}

	public static ActionNode getActionNode(ActionEvent evt) {
	}

	public ActionEvent fireEvent(com.codename1.rad.events.EventContext context) {
	}

	public ActionEvent fireEvent(com.codename1.rad.models.Entity entity, Component source) {
	}

	public ActionEvent fireEvent(com.codename1.rad.models.Entity entity, Component source, java.util.Map extraData) {
	}
	...
	public Component createView(com.codename1.rad.models.Entity entity) {
	}

	public Command createCommand(com.codename1.rad.models.Entity entity, Component source) {
	}
