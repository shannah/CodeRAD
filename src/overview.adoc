...
. https://github.com/shannah/RADChatRoom[RADChatRoom] - A full-featured messaging application UI that can be used to add "Chat" capability to your app.
+
...
See the {@link com.codename1.rad.ui.entityviews} package for a list of available components, although this list wouldn't include 3rd-party components that use CodeRAD as a dependency (e.g. https://github.com/shannah/RADChatRoom[RADChatRoom]).
