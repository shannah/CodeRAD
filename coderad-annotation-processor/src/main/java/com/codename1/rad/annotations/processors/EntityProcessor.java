...
import com.codename1.rad.annotations.RADEntity;
...
import com.codename1.rad.annotations.RADTags;
import com.codename1.rad.annotations.RADSchema;
...
public class EntityProcessor extends AbstractProcessor {
    ...
    private boolean isA(TypeElement el, String qualifiedName, RoundEnvironment roundEnv) {
        ...
        if (true) {
            return processingEnv.getTypeUtils().isAssignable(mirror, processingEnv.getElementUtils().getTypeElement(qualifiedName).asType());
        }
        ...
        if (superClass != null) {
            ...
            if (isA(superClassTypeEl, qualifiedName, roundEnv)) {
                return true;
            }
        }
        for (TypeMirror i : el.getInterfaces()) {
            ...
            if (isA(interfaceEl, qualifiedName, roundEnv)) {
                return true;
            }
        }
        return false;
